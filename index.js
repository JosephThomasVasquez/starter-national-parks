...
const submitHandler = (event) => {
  ...
  for (let element of errorElements) {
    //  Set display to none so the errors are removed from the page
  ...
  Object.keys(errors).forEach((key) => {
    ...
    // Set the innerHTML to the value of the error matching the key
    errorElement.innerHTML = errors[key];
    // Set display to block so the error is visible
...
// == VALIDATION ===================================================================================
/*
validateExists accepts a single string value and returns true if the value isn't null, 
and the string contains at least one non-space character.
*/

/*
validateNumber function validates that a given value is actually a number,
and validateRange validates the number in a specific range.
*/
...
/*
The validateForm function will take each input field, perform required validation on it,
and generate a collection of error messages which may then be displayed for the user.
*/
...
// Run the main function when DOM finished loading
